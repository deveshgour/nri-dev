<?php
					...
					?>
<div class="feed-box rounded-10" id="postdetail-<?php echo $rows->major_id; ?>">
                        <div class="feedTop">
                            <div class="userInfo d-flex align-items-center">
								...
								<?php /* ?><div class="singlepostdel"><a href="javascript:void(0);" id="delete_post" data-postid="<?php echo $rows->major_id; ?>" class="postdel<?php echo $rows->major_id; ?>"><span class="icon-trash-2"  data-postid="<?php echo $rows->major_id; ?>"></span></a></div><?php */ ?>
								...
								<div class="btn-group postActionMenu">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <li> <a href="javascript:void(0);" id="delete_major" data-postid="<?php echo $rows->major_id; ?>" class="majordel<?php echo $rows->major_id; ?>"><span class="icon-trash-2"  data-postid="<?php echo $rows->major_id; ?>"></span>Delete</a></li>

                                        <li><a href="javascript:void(0);" data-target="#editPost_<?php echo $rows->major_id ?>" data-toggle="modal"><span class="icon-edit-2"></span>  Edit Post</a></li>
...
<div class="modal fade" id="editPost_<?php echo $rows->major_id; ?>" tabindex="-1" role="dialog" 
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class='form-group'>
                       ...
                       <textarea rows="3" class="form-control h-150" name="edit_post" id="edit_post_<?php echo $rows->major_id; ?>"><?php echo $rows->post; ?></textarea>    
			...
			<button type="submit" data-post-id = "<?php echo $rows->major_id; ?>" name="editpost_submit" id="editmajorpost_submit<?php echo $rows->major_id; ?>" class=' btn btn-primary submit-button mr-2'>Submit</button>
...
<!----------------------------------------------------------------------------------------------------------------------------- -->
                            ...
                            <div class="feedImg mb-3">
                                ...
                                <div class="feedCaption">
                                     <p id="edit_post_text_<?php echo $rows->major_id; ?>"><?php echo $rows->post; ?>
                                    </p>
                                </div>
				  ...
				  <source src="<?php echo base_url(); ?>upload/<?php echo $rows->media_path; ?>" type="video/mp4">
							...
							<?php  
	    $likeType = $this->Common_model->getsingle('like_major', array('major_id' => $rows->major_id,'status'=>1,'user_id' => $this->session->userdata('userId')['user_id'])); 
		$count_like_one = $this->Common_model->jointwotable('like_major', 'user_id', 'users', 'user_id',array('major_id' => $rows->major_id,'like_major.status'=>1,'users.status'=>2),'users.user_id,users.firstname,users.lastname,like_major.like_major_id'); 
	//echo $rows->major_id.'<br>';
	//echo $this->db->last_query();die;
	$count_like_ss = $this->Common_model->joint($rows->major_id);
	//echo '<pre>';print_r($count_like_ss); die;
	
$getallcomment = $this->Common_model->commentpaginationmajor(array("major_id" => $rows->major_id),3,0,"comment_major_id", "desc");
$totalcommentcount = $this->Common_model->countwhereuser("comment_major",array("major_id" => $rows->major_id));
							 ?>
							
                            <div class="d-flex justify-content-between">
                                <div id="likecountbox-<?php echo $rows->major_id; ?>" class="font-sm" data-likecount="<?php echo COUNT($count_like_one); ?>" >  <span><?php echo COUNT($count_like_one); ?> people like this</span><?php /* ?>Kavi Singh and 200 other liked<?php */ ?></div>
                                <?php if($totalcommentcount != "0"){ ?><div class="comments"><span class="totalcmt<?php echo $rows->major_id; ?>"><?php echo $totalcommentcount; ?></span> Comments</div><?php } ?>
                            </div>
                        </div>
                        <div class="feedBottom">
                            <div class="likeShare d-flex align-items-center justify-content-between">
                                <div class="left">
                                   <a href="javascript:void(0)" class="link-dark like_major" <?php if($likeType){ ?>style="color:#009688;"<?php } ?> id="like-<?php echo $rows->major_id; ?>" data-status="1" data-type="1" data-author="<?php echo $rows->user_id; ?>" data-postid="<?php echo $rows->major_id; ?>"><span
                            ...
                            <ul class="list-unstyled comment-list commentshow-<?php echo $rows->major_id; ?>">
							<div class="sds<?php echo $rows->major_id; ?>">
                                ...
                                <li class="d-flex">
                                   ...
                                   <div class="cntText">
                                    ...
                                    <b><a href="javascript:;" class="link-dark replyshow" data-commentid="<?php echo  $allcomment->comment_major_id; ?>">Reply</a></b>
										...
										<b><a href="javascript:void(0)" class="link-dark comment_major_like_post" <?php if($getmylikecomment){ ?><?php } ?> id="likecomment-<?php echo $allcomment->comment_major_id; ?>" data-status="1" data-type="1" data-author="<?php echo $allcomment->user_id; ?>" data-postid="<?php echo $rows->major_id; ?>" data-commentid="<?php echo $allcomment->comment_major_id; ?>">
...
<!----------------------------------------------------------------------------------------------------------------------------- --> 
							   ...
							   <div class="btn-group postActionMenu">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                                                                ...
                                                                                <li> <a class="trashmajorcomments<?php echo  $allcomment->comment_major_id; ?>" href="javascript:void(0);" id="deleteComment" data-postid="<?php echo $rows->major_id; ?>" data-commentid="<?php echo  $allcomment->comment_major_id; ?>"><span class="del trashcomment" data-commentid="<?php echo  $allcomment->comment_major_id; ?>" data-postid="<?php echo $rows->major_id; ?>">Delete</span></a></li>
...
<!----------------------------------------------------------------------------------------------------------------------------- -->
				...
				<div class="seeComment my-3"><center style="text-align: left;color:black;"><a class="moremajorimage" data-postid="<?php echo $rows->major_id; ?>" data-page="1" href="javascript:void(0);">See more comments</a></center></div>
							<?php }}else{ ?>
							
							<?php } ?>
                                </div>
                            </ul>
                           <form id="cmtmajorform-<?php echo $rows->major_id; ?>" data-postid="<?php echo $rows->major_id; ?>" data-userid="<?php echo $this->session->userdata("userId")['user_id']; ?>" action="" method="post" >
                            <input type="hidden" name="postId" id="postId" value="<?php echo $rows->major_id; ?>" >
							...
							<div class="postComment d-flex align-items-center pt-2">
                                ...
                                <div class="inputBox position-relative">
                                    <input type="text" class="form-control newpostcomment post_comment-<?php echo $rows->major_id; ?>" name="post_comment" id="post_comment" data-cmtid="<?php echo $rows->major_id; ?>" value="" placeholder="Write a public comment">
                                    <button class="border-0 bg-transparent font-sm postVal_<?php echo $rows->major_id; ?>" disabled id="postVal">Post</button>
                                </div>
                            </div>
							</form>
                        </div>
