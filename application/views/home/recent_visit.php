                    ...
                    <div class="feed-box rounded-10" id="postdetail-<?php echo $row->visit_id; ?>">
                        ...
                        <div class="feedTop">
                            <div class="userInfo d-flex align-items-center">
								...
								<div class="singlepostdel"><a href="javascript:void(0);" id="delete_visit" data-postid="<?php echo $row->visit_id; ?>" class="visitdel<?php echo $row->visit_id; ?>"><span class="icon-trash-2"  data-postid="<?php echo $row->visit_id; ?>"></span></a></div>
								<?php } ?>
							</div>
			  ...
			  $getuser = $this->Common_model->getsingle("users",array("user_id" => $allcomment->user_id)); ?>
                            <span class="newflex<?php echo $allcomment->comment_visit_id; ?>">  
							  <li class="d-flex">
									...
									<div><a href="javascript:void(0);" id="deleteComment" data-commentid="<?php echo  $allcomment->comment_visit_id; ?>"><span class="icon-trash-2 trashvisitcomment" data-commentid="<?php echo  $allcomment->comment_visit_id; ?>" data-postid="<?php echo $row->visit_id; ?>"></span></a></div>
