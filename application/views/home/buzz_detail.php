			  ...
			  $getuser = $this->Common_model->getsingle("users",array("user_id" => $allcomment->user_id)); ?>
                            <span class="newflex<?php echo $allcomment->comment_buzz_id; ?>">  
							  <li class="d-flex">
									...
									<?php if($allcomment->user_id == $this->session->userdata('userId')['user_id']){ ?><div><a href="javascript:void(0);" id="deleteComment" data-commentid="<?php echo  $allcomment->comment_buzz_id; ?>"><span class="icon-trash-2 trashbuzzcomment" data-commentid="<?php echo  $allcomment->comment_buzz_id; ?>" data-postid="<?php echo $detail->buzz_id; ?>"></span></a></div><?php } ?>
