...
<?php
	...
	<!---------------------------------------reply comment like----------------------------------- -->
		...
		<?php $replycomment_like_count = $this->Common_model->getAllwhereorder("replycomment_like",array("replycomment_id" => $allcomment->reply_id),"replycomment_id","desc");
			 $getmyreplylikecomment = $this->Common_model->getsingle("replycomment_like",array("replycomment_id" => $allcomment->reply_id,"user_id" => $this->session->userdata('userId')['user_id']));
			 ?>
		 <!---------------------------------------------------------------------------------------------------------------------------------- -->							  
					 ...
					 <span class="newflex newreplyspan">  
							  <li class="d-flex new-reply-cmt-li">
							   ...
							   <div class="replycmtdivcls" id="likereplycommentcountbox-<?php echo $allcomment->reply_id; ?>"><span class="replycmtspan"><?php echo count($replycomment_like_count); ?></span></div>Like</a></b>
