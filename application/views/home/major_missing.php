                            ...
                            <div class="userInfo d-flex align-items-center">
								...
								<div class="btn-group postActionMenu">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <li> <a href="javascript:void(0);" id="delete_major" data-postid="<?php echo $row->major_id; ?>" class="majordel<?php echo $row->major_id; ?>"><span class="icon-trash-2"  data-postid="<?php echo $row->major_id; ?>"></span>Delete</a></li>

                                        <li><a href="javascript:void(0);" data-target="#editPost_<?php echo $row->major_id ?>" data-toggle="modal"><span class="icon-edit-2"></span>  Edit Post</a></li>
...
<div class="modal fade" id="editPost_<?php echo $row->major_id; ?>" tabindex="-1" role="dialog" 
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class='form-group'>
                       ...
                       <textarea rows="3" class="form-control h-150" name="edit_post" id="edit_post_<?php echo $row->major_id; ?>"><?php echo $row->post; ?></textarea>    
			...
			<button type="submit" data-post-id = "<?php echo $row->major_id; ?>" name="editpost_submit" id="editmajorpost_submit<?php echo $row->major_id; ?>" class=' btn btn-primary submit-button mr-2'>Submit</button>
...
<!----------------------------------------------------------------------------------------------------------------------------- -->
                            ...
                            <div class="feedImg mb-3">
                                ...
                                <div class="feedCaption">
                                    <p id="edit_post_text_<?php echo $row->major_id; ?>"><?php echo $row->post; ?>
                                    </p>
                                </div>
