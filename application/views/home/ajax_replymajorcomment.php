...
<?php
	...
	<!---------------------------------------reply comment like----------------------------------- -->
		...
		<?php $replycomment_like_count = $this->Common_model->getAllwhereorder("replycomment_major_like",array("replycomment_id" => $allcomment->reply_id),"replycomment_id","desc");

			 $getmyreplylikecomment = $this->Common_model->getsingle("replycomment_major_like",array("replycomment_id" => $allcomment->reply_id,"user_id" => $this->session->userdata('userId')['user_id']));
							  ...
							  <li class="d-flex new-reply-cmt-li">
							   ...
							   <div class="btn-group postActionMenu">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <li> <a href="javascript:void(0);" id="deletereplyComment<?php echo $allcomment->reply_id; ?>" data-replycommentid="<?php echo  $allcomment->reply_id; ?>" data-commentid="<?php echo  $allcomment->comment_id; ?>"><span class="del" data-replycommentid="<?php echo  $allcomment->reply_id; ?>" data-commentid="<?php echo  $allcomment->comment_id; ?>" data-postid="<?php echo $allcomment->post_id; ?>">Delete</span></a></li>

                                        <li><a href="javascript:void(0);" data-target="#editreplycomment_<?php echo $allcomment->reply_id; ?>" data-toggle="modal">Edit</a></li>
...
<div class="modal fade" id="editreplycomment_<?php echo $allcomment->reply_id; ?>" tabindex="-1" role="dialog" 
   ...
   <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="modal-content">
			...
			<button type="submit" data-reply-id="<?php echo $allcomment->reply_id; ?>" name="editreplycomment_submit" id="editmajorreplycomment_submit<?php echo $allcomment->reply_id; ?>" class=' btn btn-primary submit-button' style="margin-left:16px;" >Submit</button>
