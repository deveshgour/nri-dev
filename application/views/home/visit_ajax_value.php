                            ...
                            <div class="userInfo d-flex align-items-center">
								...
								<div class="btn-group postActionMenu">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <li> <a href="javascript:void(0);" id="delete_visit" data-postid="<?php echo $rows->visit_id; ?>" class="visitdel<?php echo $rows->visit_id; ?>"><span class="icon-trash-2"  data-postid="<?php echo $rows->visit_id; ?>"></span>Delete</a></li>

                                        <li><a href="javascript:void(0);" data-target="#editPost_<?php echo $rows->visit_id ?>" data-toggle="modal"><span class="icon-edit-2"></span>  Edit Post</a></li>
...
<div class="modal fade" id="editPost_<?php echo $rows->visit_id; ?>" tabindex="-1" role="dialog" 
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class='form-group'>
                       ...
                       <textarea rows="3" class="form-control h-150" name="edit_post" id="edit_post_<?php echo $rows->visit_id; ?>"><?php echo $rows->post; ?></textarea>    
			...
			<button type="submit" data-post-id = "<?php echo $rows->visit_id; ?>" name="editpost_submit" id="editvisitpost_submit<?php echo $rows->visit_id; ?>" class=' btn btn-primary submit-button mr-2'>Submit</button>
...
<!----------------------------------------------------------------------------------------------------------------------------- -->
                            ...
                            <div class="feedImg mb-3">
                                ...
                                <div class="feedCaption">
                                    <p id="edit_post_text_<?php echo $rows->visit_id; ?>"><?php echo $rows->post; ?>
                                    </p>
                                </div>
...
$totalcommentcount = $this->Common_model->countwhereuser("comment_visit",array("visit_id" => $rows->visit_id));
                        ...
                        <div class="feedBottom">
                            <div class="likeShare d-flex align-items-center justify-content-between">
                                <div class="left">
                                   <a href="javascript:void(0)" class="link-dark like_visit" <?php if($likeType){ ?>style="color:#009688;"<?php } ?> id="like-<?php echo $rows->visit_id; ?>" data-status="1" data-type="1" data-author="<?php echo $rows->user_id; ?>" data-postid="<?php echo $rows->visit_id; ?>"><span
                                ...
                                <li class="d-flex">
                                   ...
                                   <div class="cntText">
                                    ...
                                    <b><a href="javascript:;" class="link-dark replyshow" data-commentid="<?php echo  $allcomment->comment_visit_id; ?>">Reply</a></b>
										...
										<b><a href="javascript:void(0)" class="link-dark comment_visit_like_post" <?php if($getmylikecomment){ ?><?php } ?> id="likecomment-<?php echo $allcomment->comment_visit_id; ?>" data-status="1" data-type="1" data-author="<?php echo $allcomment->user_id; ?>" data-postid="<?php echo $allcommentvisit_id; ?>" data-commentid="<?php echo $allcomment->comment_visit_id; ?>">
...
<!----------------------------------------------------------------------------------------------------------------------------- --> 
							   ...
							   <?php }
                                    ...
                                    <input type="text" class="form-control replycmtval_<?php echo $allcomment->comment_visit_id; ?>" name="reply_comment" id="reply_comment" data-post_id="<?php echo $allcommentvisit_id; ?>" data-comment_id="<?php echo $allcomment->comment_visit_id; ?>" data-comment_user_id="<?php echo $allcomment->user_id; ?>" data-user_id="<?php echo $this->session->userdata("userId")["user_id"]; ?>" value="" placeholder="Write a public comment">

                                   <button class="border-0 bg-transparent font-sm replyCombtn_<?php echo $allcomment->comment_visit_id; ?>" id="postValvisit<?php echo $allcomment->comment_visit_id; ?>" data-post_id="<?php echo $allcommentvisit_id; ?>" data-comment_id="<?php echo $allcomment->comment_visit_id; ?>" data-comment_user_id="<?php echo $allcomment->user_id; ?>" data-user_id="<?php echo $this->session->userdata("userId")["user_id"]; ?>">Post</button>
									...
									<?php /* ?><div><a href="javascript:void(0);" id="deleteComment" data-commentid="<?php echo  $allcomment->comment_id; ?>"><span class="icon-trash-2 trashcomment" data-commentid="<?php echo  $allcomment->comment_id; ?>" data-postid="<?php echo $allcommentpost_id; ?>"></span></a></div><?php */ ?>
							   ...
							   <div class="btn-group postActionMenu">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                                                                ...
                                                                                <li> <a class="trashvisitcomments<?php echo  $allcomment->comment_visit_id; ?>" href="javascript:void(0);" id="deleteComment" data-postid="<?php echo $allcommentvisit_id; ?>" data-commentid="<?php echo  $allcomment->comment_visit_id; ?>"><span class="del trashcomment" data-commentid="<?php echo  $allcomment->comment_visit_id; ?>" data-postid="<?php echo $allcommentvisit_id; ?>">Delete</span></a></li>
...
<!----------------------------------------------------------------------------------------------------------------------------- -->
				...
				<div class="seeComment my-3"><center style="text-align: left;color:black;"><a class="morevisitimage" data-postid="<?php echo $rows->visit_id; ?>" data-page="1" href="javascript:void(0);">See more comments</a></center></div>
                           ...
                           <form id="cmtvisitform-<?php echo $rows->visit_id; ?>" data-postid="<?php echo $rows->visit_id; ?>" data-userid="<?php echo $this->session->userdata("userId")['user_id']; ?>" action="" method="post" >
