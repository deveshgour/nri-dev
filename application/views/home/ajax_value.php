			   ...
			   <span class="newflex<?php echo $allcomment->comment_id; ?>"> 
                                <li class="d-flex">
                                   ...
                                   <div class="cntText">
									...
									<div><a href="javascript:void(0);" id="deleteComment" data-commentid="<?php echo  $allcomment->comment_id; ?>"><span class="icon-trash-2 trashcomment" data-commentid="<?php echo  $allcomment->comment_id; ?>" data-postid="<?php echo $rows->post_id; ?>"></span></a></div>
                                </li>
								</span>
								<?php }
                           ...
                           <form id="cmtform-<?php echo $rows->post_id; ?>" data-postid="<?php echo $rows->post_id; ?>" data-userid="<?php echo $this->session->userdata("userId")['user_id']; ?>" action="" method="post" >
							...
							<div class="postComment d-flex align-items-center pt-2">
                                ...
                                <div class="inputBox position-relative">
                                    <input type="text" class="form-control post_comment-<?php echo $rows->post_id; ?>" name="post_comment" id="post_comment" value="" placeholder="Write a public comment">
