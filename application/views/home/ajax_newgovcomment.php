...
<?php  
     if(!empty($getallcomment)){
         ...
         <?php }if($getallcomment['num_rows'] > count($getallcomment['rows'])){ ?>
				<div class="seeComment my-3"><center style="text-align: left;color:black;"><a class="moregovimage" data-postid="<?php echo $allcomment->gov_id; ?>" data-page="<?php echo $offset; ?>" href="javascript:void(0);">See more comments</a></center></div>		
				<?php }
	 }else{ ?>
