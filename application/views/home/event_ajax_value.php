...
<div class="feed-box rounded-10" id="postdetail-<?php echo $rows->event_id; ?>">
                        <div class="feedTop">
                            <div class="userInfo d-flex align-items-center">
								...
								<div class="singlepostdel"><a href="javascript:void(0);" id="delete_post" data-postid="<?php echo $row->event_id; ?>" class="postdel<?php echo $row->event_id; ?>"><span class="icon-trash-2"  data-postid="<?php echo $row->event_id; ?>"></span></a></div>
								<?php } ?>
						   </div>
			   ...
			   <span class="newflex<?php echo $allcomment->comment_event_id; ?>"> 
                                <li class="d-flex">
                                   ...
                                   <div class="cntText">
									...
									<div><a href="javascript:void(0);" id="deleteComment" data-commentid="<?php echo  $allcomment->comment_event_id; ?>"><span class="icon-trash-2 trashcomment" data-commentid="<?php echo  $allcomment->comment_event_id; ?>" data-postid="<?php echo $rows->event_id; ?>"></span></a></div>
                                </li>
								</span>
								<?php }
				...
				<div class="seeComment my-3"><center style="text-align: left;color:black;"><a class="moreeventimage" data-postid="<?php echo $rows->event_id; ?>" data-page="1" href="javascript:void(0);">See more comments</a></center></div>
                           ...
                           <form id="cmtform-<?php echo $rows->event_id; ?>" data-postid="<?php echo $rows->event_id; ?>" data-userid="<?php echo $this->session->userdata("userId")['user_id']; ?>" action="" method="post" >
