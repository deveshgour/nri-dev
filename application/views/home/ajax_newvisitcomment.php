     ...
     if(!empty($getallcomment)){
	      foreach($getallcomment['rows'] as $allcomment){
			 ...
			 <li class="d-flex">
									...
									<div><a href="javascript:void(0);" id="deleteComment" data-commentid="<?php echo  $allcomment->comment_visit_id; ?>"><span class="icon-trash-2 trashvisitcomment" data-commentid="<?php echo  $allcomment->comment_visit_id; ?>" data-postid="<?php echo $post_id; ?>"></span></a></div>
                                </li>
								</span>
