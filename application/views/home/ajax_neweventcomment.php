			 ...
			 <li class="d-flex">
                                    ...
                                    <div class="cntText">
                                     ...
                                     <b><a href="javascript:;" class="link-dark replyshow" data-commentid="<?php echo  $allcomment->comment_event_id; ?>">Reply</a></b>
										...
										<b><a href="javascript:void(0)" class="link-dark comment_event_like_post" <?php if($getmylikecomment){ ?><?php } ?> id="likecomment-<?php echo $allcomment->comment_event_id; ?>" data-status="1" data-type="1" data-author="<?php echo $allcomment->user_id; ?>" data-postid="<?php echo $allcomment->event_id; ?>" data-commentid="<?php echo $allcomment->comment_event_id; ?>">
...
<!----------------------------------------------------------------------------------------------------------------------------- --> 
							   ...
							   <?php }
                                    ...
                                    <input type="text" class="form-control replycmtval_<?php echo $allcomment->comment_event_id; ?>" name="reply_comment" id="reply_comment" data-post_id="<?php echo $allcomment->event_id; ?>" data-comment_id="<?php echo $allcomment->comment_event_id; ?>" data-comment_user_id="<?php echo $allcomment->user_id; ?>" data-user_id="<?php echo $this->session->userdata("userId")["user_id"]; ?>" value="" placeholder="Write a public comment">

                                   <button class="border-0 bg-transparent font-sm replyCombtn_<?php echo $allcomment->comment_event_id; ?>" id="postValevent<?php echo $allcomment->comment_event_id; ?>" data-post_id="<?php echo $allcomment->event_id; ?>" data-comment_id="<?php echo $allcomment->comment_event_id; ?>" data-comment_user_id="<?php echo $allcomment->user_id; ?>" data-user_id="<?php echo $this->session->userdata("userId")["user_id"]; ?>">Post</button>
...
<!----------------------------------------------------------------------------------------------------------------------------- -->
         ...
         <?php }if($getallcomment['num_rows'] > count($getallcomment['rows'])){ ?>
				<div class="seeComment my-3"><center style="text-align: left;color:black;"><a class="moreeventimage" data-postid="<?php echo $allcomment->event_id; ?>" data-page="<?php echo $offset; ?>" href="javascript:void(0);">See more comments</a></center></div>		
				<?php }
	 }else{ ?>
