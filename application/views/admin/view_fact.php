        ...
        <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Interesting fact Detail</h1>
						<button onclick="goBack()" style="float:right"> Back</button>
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                               ...
                                               <span class="new-control"><?php echo $view_fact->title; ?></span>
                                            </div>
											</div>
											<div class="col-md-6">
                                            <div class="form-group">
                                               <span class="new-control"><?php echo $view_fact->description; ?></span>
                                            ...
                                            <div class="form-group">
												...
												<?php if(!empty($view_fact->image)){ ?>
												  <img src="<?php echo base_url(); ?>upload/<?php echo $view_fact->image; ?>" width="50%">
												<?php } ?>
                                            </div>
											</div>
											<div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <span class="new-control"><?php if($view_fact->status == 1){ echo "Active"; }else{ echo "Deactive"; } ?></span>
                                            </div>
											</div>
