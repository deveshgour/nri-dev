                        ...
                        ?>
                                    <div class="card-body">
                                         <form id="rootdetail" action="" name="rootdetail" method="post" enctype="multipart/form-data">
											...
											<div class="col-md-6">
                                            <div class="form-group">
                                                <label class="small mb-1" for="description">Url</label>
                                                <input class="form-control py-4" id="url" type="text" name="url" placeholder="Url" />
                                            </div>
											</div>
											<div class="col-md-6">
                                            <div class="form-group">
                                                <label class="small mb-1" for="description">Description</label>
                                                <textarea name="description" id="description" class="form-control py-4" ></textarea> 
                                            </div>
											</div>
											<div class="col-md-6">
                                            <div class="form-group">
